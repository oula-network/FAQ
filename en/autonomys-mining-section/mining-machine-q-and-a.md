...
**A:** Please refer to the [mining tutorial](../start-mining/publish-your-docs.md#recommended-software-and-hardware-configuration) for the recommended hardware configuration.
